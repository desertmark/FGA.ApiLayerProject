...
using FGA.Congressus2.Api.Models;
using FGA.Congressus2.Api.Providers;
using FGA.Congressus2.Api.Results;
using FGA.Congressus2.Entities.Entities;
using System.Data.Entity.Core;
using FGA.Congressus2.Negocio.Negocio;

namespace FGA.Congressus2.Api.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        private UsuarioNegocio _userManager;

        public AccountController()
        {
        }

        public AccountController(UsuarioNegocio userManager,
        ...
        public UsuarioNegocio UserManager
        {
            get
            {
                return _userManager ?? Request.GetOwinContext().GetUserManager<UsuarioNegocio>();
            }
            private set
            {
                _userManager = value;
